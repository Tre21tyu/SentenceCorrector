...
const sen_1 = "Necesito aumentar español";
const sen_2 = "Necesito aumentar español";
const redResult = redIncorrect(sen_1, sen_2);
const greenResult = greenCorrect(sen_1, sen_2);
console.log(textModify(redResult, greenResult));
