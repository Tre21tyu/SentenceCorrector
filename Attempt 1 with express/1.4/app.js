...
import textModify from "./controllers/textModify.js"; // Import a custom controller function for text modification.
...
app.get("/", (req, res) => {
  ...
  res.sendFile(__dirname + "/public/indexWorking.html");
});
